...
<template>
  <div v-loading="loading">
    <er-form-editor :checkPropsBySelected="checkPropsBySelected" :checkFieldsForNewBadge="checkFieldsForNewBadge"
      v-if="isRender" :quickImages="quickImages" :layoutType="layoutType" :lang="lang" @listener="handleListener"
      :fileUploadURI="uri.uploadFile" ref="EReditorRef" />
  </div>
</template>
